...
export const MBTI_DESCRIPTIONS: Record<string, MBTIStaticInfo> = {
  // We will populate a generic fallback. The real "meat" comes from Gemini or this fallback.
  // For brevity in this code generation, I'll provide a generic template generator in the component
  // to save 1000 lines of hardcoded text, relying on Gemini for the premium content.
  "DEFAULT": {
